...
--
-- Host: localhost:3306
-- Generation Time: Oct 31, 2017 at 02:51 AM
...
CREATE TABLE IF NOT EXISTS `productdetails` (
  ...
  `LocalName(Nepali Name))` text NOT NULL,
...
INSERT INTO `productdetails` (`productID`, `EnglishName`, `LocalName(Nepali Name))`, `BotanicalName`, `FamilyName`, `Season`, `PartsUsed`, `Description`, `Appearance`, `Aroma`, `FlashPoint`, `SpecificGravity`, `RefractiveIndex`, `RelativeIndex`, `EsterValue`, `Ester Value After Acetylation`, `OpticalRotation`, `AcidNumber`, `TotalAlcohol`, `Solubility`, `Solubleinwater`, `CountryofOrigin`, `Uses`, `Packaging`) VALUES
