...
<div id="footerContactUs">
    <div class="container-fluid">        
        ...
        <div class="row">
            ...
            <div class="col-xs-4"> 
            <div id="copyright">
               <center><a href="index.php" class="footerNoUnderline">&copyEverest Aroma<br>
                2017</a></center>
            </div>
            </div>
           <div class="col-xs-4"> 
                <center>
                <div id="design"> Designed by <br><a class="footerNoUnderline" href="http://gtechdevelopers.com.np/" target="_blank" >Gtech Developers</a></div>
                   </center> 
            </div> <!-- for spacing -->
