...
('everest', 'bcb759b5b8ab63b06295c7434345d7a5');
...
(7, ' Dhanusa Project\r\n						', ' Everest Aroma, the leading essential oil processing company of our country is seeking the options for enhancing the economic condition of our country by fostering local development through a recently proposed project in Dhanusha, Eastern Nepal. The detailed study and survey has been carried successfully and the project is marked as feasible from every aspects. The farming for German Chamomile, Lemongrass, Citronella, Pamarosa, and Basil has been planned as the climate under study is suitable for these plants. EA plans on seeking local participation by encouraging local farmers and community with the aid of grants and assistance for farming. Also, for collateral encouragement, EA plans to make cultivation of their own.', 'Uploads/dhanusa teaching.jpg');
...
CREATE TABLE IF NOT EXISTS `productdetails` (
  ...
  `English Name` text NOT NULL,
  `Local Name (Nepali Name))` text NOT NULL,
  `BotanicalName` text NOT NULL,
  `Family Name` text NOT NULL,
  `Season` text NOT NULL,
  `Parts Used` text NOT NULL,
  `Description` text NOT NULL,
  `Appearance` text NOT NULL,
  `Aroma` text NOT NULL,
  `Flash Point` text NOT NULL,
  `Specific Gravity` text NOT NULL,
  `Refractive Index` text NOT NULL,
  `Relative Index` text NOT NULL,
  `Ester Value` text NOT NULL,
  `Ester Value after Acetylation` text NOT NULL,
  `Optical Rotation` text NOT NULL,
  `Acid Number` text NOT NULL,
  `Total Alcohol` text NOT NULL,
  `Solubility` text NOT NULL,
  `Soluble in water` text NOT NULL,
...
INSERT INTO `productdetails` (`productID`, `English Name`, `Local Name (Nepali Name))`, `BotanicalName`, `Family Name`, `Season`, `Parts Used`, `Description`, `Appearance`, `Aroma`, `Flash Point`, `Specific Gravity`, `Refractive Index`, `Relative Index`, `Ester Value`, `Ester Value after Acetylation`, `Optical Rotation`, `Acid Number`, `Total Alcohol`, `Solubility`, `Soluble in water`, `Country of Origin`, `Uses`, `Packaging`) VALUES
...
(1, 'Anthopogon', 'Uploads/Anthopogon.png', 'no', 'yes'),
(2, 'Basil', 'Uploads/Basil.png', 'yes', 'no'),
(3, 'Calamus', 'Uploads/Calamus.png', 'yes', 'no'),
(4, 'Chamomile', 'Uploads/Chamomile.png', 'no', 'no'),
(5, 'Citronella', 'Uploads/Citronella.png', 'yes', 'no'),
(6, 'Eucalyptus', 'Uploads/Eucalyptus.png', 'yes', 'no'),
(7, 'Juniper Berry', 'Uploads/Juniper.png', 'yes', 'yes'),
(8, 'Lemongrass', 'Uploads/Lemongrass.png', 'yes', 'yes'),
(9, 'Mentha arvensis', 'Uploads/Mentha.png', 'yes', 'no'),
...
(13, 'Wintergreen', 'Uploads/Wintergreen.png', 'no', 'yes'),
